...
total de bytes cahr(10) = 10 bytes
...
RESPOSTA:
	...
	select nome,count(*) from funcionarios where nome = 'Wood';
...
SELECT COUNT(*), departamento
FROM FUNCIONARIOS group by departamento order by 1;
...
RESPOSTAS:
	Todos os funcionários que trabalham no departamento jardim
	select * from funcionarios where departamento = 'Jardim';

	Todos os funcionários do sexo masculino que trabalham no departamento jardim
	select * from funcionarios where sexo = 'Masculino' and departamento = 'Jardim';
